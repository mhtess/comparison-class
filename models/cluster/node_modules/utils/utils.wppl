...
// var lowerBins = map(roundTo3, _.range(0, 1, 0.05))
// var upperBins = map(roundTo3, _.range(0.01, 1.01, 0.05))
...
var readDataFile = function(fileName, numeric_fields){
  // var fileName = dataPath +"/"+filePrefix+"-trials.csv";
  return dataFrame(utils.readCSV(fileName).data, numeric_fields)
  // return dataFrame(utils.readCSV(fileName).data, [/"response", "prevalence_level"])
}

// var readCatchFile = function(filePrefix){
//   var fileName = dataPath +"/"+filePrefix+"-catch_trials.csv";
//   return dataFrame(utils.readCSV(fileName).data, ["workerid", "tested_on", "correct"])
// }
//
// var readSubjFile = function(filePrefix){
//   var fileName = dataPath +"/"+filePrefix+"-subject_information.csv";

...
d.tidy.phrase.classified <- d.tidy.resp.valid.resps %>% 
  ...
  mutate(cat_cleanedPhrase = cleanedPhrase,
         cat_cleanedPhrase = gsub("rinks", "ice rink", cat_cleanedPhrase),
       ...
       #  cat_cleanedPhrase = gsub("days", "seasons", cat_cleanedPhrase),
         cat_cleanedPhrase = gsub("pans", "frying pan", cat_cleanedPhrase),
    ...
    #     cat_cleanedPhrase = gsub("fondues", "chocolate fondues", cat_cleanedPhrase),
     ...
     #    cat_cleanedPhrase = gsub("malls", "strip mall", cat_cleanedPhrase),
      ...
      #   cat_cleanedPhrase = gsub("gate", "front gate", cat_cleanedPhrase),
         cat_cleanedPhrase = gsub("ink", "pen", cat_cleanedPhrase),
...
d.tidy.resp.analysis.update <- d.tidy.phrase.classified %>% filter((specific == 0) & (matchingSuper == 0))  %>% distinct(degree, superordinate, np, adj, np_match, cleanedPhrase, specific, matchingSuper)
```
...
d.tidy.phase.classifiedSuper <- d.tidy.phrase.classified %>%
  mutate(
    cleanedPhrase = gsub("age", "people", cleanedPhrase),

...
synonym_set = c("6 packs" = "beer",
         ...
         "pedestrian" = "walker",
         "forms of cooking" = "cookware",
        "computers" = "laptop",
         "spirits" = "liquor",
         "means of cooking" = "cookware",
         "modes of cooking" = "cookware",
         ...
         "cookers" = "cookware",
         "cooking devices" = "cookware",
         "cooking instruments" = "cookware",
         "cooking items" = "cookware",
         "cooking options" = "cookware",
         "cooking styles" = "cookware",
         ...
         "ways of cooking" = "cookware",
         "ways to cook" = "cookware",
         "ways to cook a meal" = "cookware",
...
hand_classification <- c("things in the room" = "things", 
                         ...
                         "cold day" = "day",
                         "compared to the noise everyone is used to" = "noise",
                         ...
                         "animals in the  aquiarium" = "animal",
                         "animals in the forest" = "animal",
                         "animals in the forrest" = "animal",
                         "animals in forest" = "animal",
                         "pieces of "= "",
                         "alcohol drinks" = "alcoholic drinks",
                         "animal houses" = "dens",
                         ...
                         "decor for sale" = "decor", 
                         "dinners" = "dinner",
                         "door of his house" = "doorways",
                         "doors in his house" = "doorwyas",
                         
                         
                         "fabric and material" = "fabric",
                         "distances" = "distance",
                         ...
                         "selling price"= "price",
                         "shades that give a stronger characteristic"= "paints",
                         "snack foods"= "snacks",
                         "sofas"= "couch",
                         ...
                         "places around her" = "places",
                         "places in kitchen" = "places",
                         "places in the house." = "places",
                         ...
                         "public areas" = "areas",
                         "public places" = "venue",
                         "meals hes made" = "meals",
                         
                         "noise around him that hes ever hears" = "noise",
                         "recipe" = "cookware", 
                         "objects in-store" = "objects",
                         "objects, in general" = "objects",
                         "passages" = "doorways",
                         "noise." = "noise",
                         ...
                         "sound around them" = "sound",
                         "sound at a lake" = "sound",
                         "sound going on in the park" = "sound",
                         "spiders" = "spider",
                         "stores" = "store",
                         "streets" = "street", 
                         "sound in the place." = "sound",
                         
                        
                         "surfaces of the bed" = "surfaces",
                         "surfaces that one may sit on" = "surfaces",
                         "speed in the highway" = "speed",
                         "spots" = "venues",
                         "squirrel coat" = "animal coat",
                         "areas." = "areas",
                         "birds at the zoo" = "bird",  
                        "cookery" = "cookware",
                         "study area" = "area",
                        "pet in the house" = "pet",
                        "pets" = "pet",
                        "place outside" ="places",
                         ...
                         "thingsthat move." = "things",
                        "thingsto move" = "things",
                         "other " = "",
                         "peunguins" = "penguin",
                         ...
                         "things on the lake" = "things",
                         "things that are fast"= "things",
                         "things that are short" = "things",
                         "things to move." = "things",
                         "things you might pick-up" = "things",
                         "things." = "things",
                         "tings which have weight"= "things",
                         "times of day of days of day" = "times of day",
                         "things he has lifted"= "things",
                         
                        "thingshe has lifted"= "things",
                        "things in the store"= "things",
                        "thingsin the store"= "things",
                         "trucks" = "truck",
                         ...
                         "forest shes been in" = "forest",
                         
                        
                         "furniture of the same type" = "furniture",
                         "general " = "",
                         "his kitchen" = "kitchen",
                        "instruments he has played before" = "instruments",
                        "instruments she has heard" = "instruments",
                        "items in the craft shop" = "items",
                        "instruments." = "instruments",
                         ...
                         "things eaten" = "things",
                         "thingshe could use to cook with" = "cookware", 
                         "things in the room" = "things",
                         "types of rain" = "storms",
                         "two-transportation" = "transportation",
                         "walking." = "walkers",
                        ...
                        "malls" = "mall",
                         ...
                         "things you pick-up" = "things",
                        "thingsyou pick-up" = "things", 
...
d.tidy.phrase.handClassified %>% filter((specific == 0) & (matchingSuper == 0)) %>%
  rowwise() %>%
        ...
        response_lemma_hand = ifelse(superordinate == "waterways",  gsub("lake", np_match,
...
d.nonMatching.resps %>% distinct(degree, superordinate, np, adj, np_match, response, response_lemma, response_lemma_hand, specific, matchingSuper) %>% View()
...
# here, the responses including the scale are caught  (181 responses)
d.scaleResps <- d.tidy.phrase.handClassified2 %>% rowwise() %>% mutate(degree_match = degree,
  ...
  filter(grepl(response_lemma_hand, degree_match, ignore.case=T))
...
``` {r}
d.tidy.super.counts <- d.tidy.resps.classified.full %>% filter((specific == 0) & (matchingSuper == 0)) %>% group_by(stim_id, superordinate, response_lemma) %>% count() %>% 
  mutate(n_unique_resps = n) %>% ungroup()
  
d.tidy.super.counts %>% filter(n_unique_resps >= 3) -> d.tidy.super.counts.common

d.tidy.super.counts %>% ungroup() %>% mutate(produced_super = ifelse(n_unique_resps >= 3, response_lemma, superordinate)) -> d.tidy.super.adjust
d.tidy.resps.classified.full %>% filter((specific == 0) & (matchingSuper == 0)) %>% left_join(., d.tidy.super.adjust, by = c("stim_id", "superordinate", "response_lemma" )) -> d.nonMatch.adjustSuper

# get number of data points which passed the grab-3 criterion
d.nonMatch.adjustSuper %>% filter(produced_super != superordinate) # n = 4888

# get the distinct superordinates for the frequency extraction
d.nonMatch.adjustSuper %>% distinct(produced_super) -> distinctSuper
distinctSuper %>% rowwise() %>% filter(stri_detect(produced_super, regex = '.s$')) %>%
  c(.$produced_super) -> pluralSuper
...
distinctSuper %>% rowwise() %>% mutate(produced_super_pl = super_plural(produced_super, pluralSuper)) -> allSuper
write_csv(allSuper, '../data/class-elicitation-prereg-final/cc-prod-distinct-super-pl.csv')
d.nonMatch.adjustSuper <- d.nonMatch.adjustSuper %>% rowwise() %>%
...
d.nonMatch.adjustSuper.filter <- d.nonMatch.adjustSuper %>%
  ...
  select(workerid, stim_id, degree, superordinate_pl, adj, adj_polarity, NP_sg = np, NP_pl, np_expectations, response = produced_super_pl, specific )
...
d.nonMatch.adjustSuper.filter.w.freqs <- d.nonMatch.adjustSuper.filter.w.freqs %>% 
  select(workerid, stim_id, degree, superordinate_pl, adj, adj_polarity, NP_sg, NP_pl, np_expectations, response, specific, subFreq = Frequencies.x, superFreq = Frequencies.y)
...
df.mode.final <- d.tidy.phrase.w.original.mode.pl %>% select(workerid, stim_id, degree, superordinate.freq, adj, adj_polarity, np, np_pl, np_expectations, mode_np, specific, Frequencies.x, Frequencies.y) %>% mutate(superordinate_pl = superordinate.freq, NP_sg = np, NP_pl = np_pl,  response = mode_np, subFreq = Frequencies.x, superFreq = Frequencies.y) %>% select(workerid, stim_id, degree, superordinate_pl, adj, adj_polarity, NP_sg, NP_pl, np_expectations, response, specific, subFreq, superFreq)
...
d.tidy.phrase.w.original.mode.pl %>% filter((specific == 1 ) | (matchingSuper == 1)) %>% select(workerid, stim_id, degree, superordinate_pl = superordinate.freq, adj, adj_polarity, NP_sg = np, NP_pl = np_pl, np_expectations, response = mode_np, specific, subFreq = Frequencies.x, superFreq = Frequencies.y) %>% rbind(., d.nonMatch.adjustSuper.filter.w.freqs) -> d.full.w.produced.super

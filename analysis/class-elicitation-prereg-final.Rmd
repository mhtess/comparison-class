...
d.tidy.phrase.handClassified %>%
  rowwise() %>%
                mutate(response_lemma_hand = ifelse( superordinate == "cookware", 
                                     gsub("pans", "frying pan", response_lemma_hand),
                                     response_lemma_hand),
                       response_lemma_hand = ifelse( superordinate == "cookware", 
                                     gsub("dinners", "cookware", response_lemma_hand),
                                     response_lemma_hand),
         ...
         response_lemma_hand = ifelse(superordinate == "times of day",  
                                    ifelse(response_lemma == "days", np_match,
                                                                             response_lemma_hand), response_lemma_hand),
         response_lemma_hand = ifelse(superordinate == "writing utensils",  gsub("ink", "pen", response_lemma_hand),
                                    response_lemma_hand),
         response_lemma_hand = ifelse(superordinate == "writing utensils",  gsub("colors", np_match, response_lemma_hand),
                                    response_lemma_hand),
         ...
         response_lemma_hand = gsub("butchershops", np_match, response_lemma_hand),
         response_lemma_hand = ifelse(superordinate == "places",  gsub("baths", "sauna", response_lemma_hand),
                                    response_lemma_hand),
         response_lemma_hand = ifelse(superordinate == "alcoholic drinks",  gsub("bottles", "wine", response_lemma_hand),
                              response_lemma_hand),
         ...
         response_lemma_hand = ifelse(degree == "weight",  gsub("childern", "kid", response_lemma_hand),
                                    response_lemma_hand),
          response_lemma_hand = ifelse(superordinate == "cakes",  gsub("colors", np_match, response_lemma_hand),
                                    response_lemma_hand),
   ...
   response_lemma_hand = ifelse(degree == "speed", gsub("appliances", "cookware", response_lemma_hand), response_lemma_hand),
    ...
    response_lemma_hand = ifelse( cleanedPhrase == "_cries_", np_match_us, cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_crying_", np_match_us, cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_episodes_", np_match_us, cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_car_", "_cars_", cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_map_", "_maps_", cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_pots_", "_cookware_", cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_settings_", super_us, cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_price_", np_match_us, cleanedPhrase),
    response_lemma_hand = ifelse( cleanedPhrase == "_pieces_", np_match_us, response_lemma_hand),
...
d.tidy.phrase.handClassified %>% mutate( cleanedPhrase = paste("_", as.character(response_lemma_hand), "_", sep=""),
    #response_lemma_cleaned = gsub("_", "", response_lemma),
    specific = containsString_responses(as.character(cleanedPhrase), as.character(np_match), response_lemma_hand,  np_match_us), 
         matchingSuper = containsString_responses(as.character(cleanedPhrase), as.character(superordinate), response_lemma_hand, super_us)
         ) -> d.tidy.phrase.handClassified
...
d.tidy.phrase.handClassified %>% filter((specific == 0) & (matchingSuper == 0)) -> d.nonMatching.resps1 
...
# here, the responses including the scale are caught  (152 responses)
...
d.HandClassified.subs.wCC <- anti_join(d.tidy.phrase.handClassified, d.scaleResps) %>% select(workerid, stim_id, degree, context_sentence, superordinate, np, np_expectations, adj, adj_polarity, np_match, response, response_lemma = response_lemma_hand, specific, matchingSuper)

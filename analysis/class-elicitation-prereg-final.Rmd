...
We extract non-classified responses for manual adjustment to either the subordinate or the superordinate anticipated NP. Some responses which occur often (based on manual analysis) are left unchanged to check if any unexpected response was the modal response for any particular condition. 
``` {r nonMatchedResps}
...
Here, we look at the responses that were not matched to our anticipated NPs and superordinates and the synonyms of the NPs we already caught. We judge if the deviating responses are synonymous to our anticipated NPs or our superordinates and adjust them.

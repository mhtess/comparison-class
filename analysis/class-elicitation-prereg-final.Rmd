...
misspellings_set <- pull(my_df, V2) %>% set_names(pull(my_df, V1))
```
...
synonym_set <- pull(my_df, V2) %>% set_names(pull(my_df, V1))
```
...
lemmatization_set <- pull(my_df, V2) %>% set_names(pull(my_df, V1))
```
...
hand_classification <- pull(my_df, V2) %>% set_names(pull(my_df, V1))

...
my_stop_words <-# bind_rows(
 ...
 my_stop_words <- stop_words %>%
     filter(!(stop_words %in% c("rooms", "year", "side", "area", "of", "up")))#,
...
d.tidy.resp.analysis.update <- d.tidy.phrase.w.original %>% filter((specific == 0) & (matchingSuper == 0))  %>% distinct(degree, superordinate, np, adj, np_match, cleanedPhrase, specific, matchingSuper)
```

...
d.nonMatch.adjustSuper %>% filter(produced_super != superordinate) # n = 2422
...
d.tidy.resps.full.handClassified.as.super.adjust.w.freq <- d.tidy.resps.full.handClassified.as.super.adjust %>% rowwise() %>%
   mutate(np_pl = insert_plural_np(tolower(np), superordinate))

...
data_path = '../data/class-elicitation-prereg-final/class-elicitation-final-full_analysis_w_pl_np.csv'
...
df_nps.to_csv('../data/class-elicitation-prereg-final/class-elicitation-final-plural_frequencies.csv')

...
df.adj.w.mode %>% select(workerid, degree, superordinate, item = np_pl, item_cond, key, val) %>% 
  write_csv( '../data/pilot-adj-endorsement-1/pilot-adj-endorsement-1-super-PL-update.csv')
```
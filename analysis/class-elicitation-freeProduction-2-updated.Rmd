...
data = read.csv(paste(path_to_repository, 
                      "/analysis/class-elicitation-freeProduction-2-types-frequencies.csv",
                      sep=""))
kable(data)
```
...
## Plots of Unique Responses

```{r echo=FALSE, fig.height=16, fig.width=10}
ggplot(data, aes(x=phrase)) + geom_bar() + 
  facet_wrap(~target+sub_category, scales="free") + 

...
\node[obs, minimum size=1cm, right=of L1_speaker] (comparison_class) {$d_{c}$} ;
\node[latent, minimum size=1cm, left=of S2_speaker] (alpha_2) {$\alpha_2$} ;
\node[obs, minimum size=1cm, right=of S2_speaker] (utterance) {$d_{u}$} ;  
...
\end{tikzpicture}
\end{center}
\caption{Comparison class RSA model.}
\end{figure}

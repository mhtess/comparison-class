...
```{r xtable, results = "asis", fig.align = "center", fig.pos = "H"}
...
table1 = data.frame(Scale = scales, Sub = sub, Super = super)
table1 <- xtable(table1)
print(table1, type = "latex", comment = F, include.rownames = FALSE, tabular.environment = "tabularx", width = "\\textwidth")
```

...
When introduced to a novel creature (*pimwits*), 4 year-olds selections of which ones are *tall* or *short* are sensitive to the distribution of heights of pimwits and, critically, not the heights of creatures that aren't pimwits [@Barner2008].
The relevant comparison class for heights of pimwits is *other pimwits*.

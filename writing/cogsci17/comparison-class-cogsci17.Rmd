...
The major feature of this approach is that participants may respond only to simple natural language questions rather than estimating numerical quantities for which complicated linking functions must be designed [@Franke2016].

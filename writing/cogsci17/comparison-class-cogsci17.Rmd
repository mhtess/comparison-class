...
We introduce a novel language understanding model that resolves its uncertainty about the comparison class alongside the uncertainty know to be important for modeling vague language understanding (namely, uncertainty about the world and uncertainty about the precise meaning of the speech act).
<!--
...
There is substantial evidence that listeners and speakers are sensitive to the comparison class when interpreting and producing adjectives.

...
-->
```{r posteriorPredictive_scatters, fig.env = "figure*", fig.pos = "htb", fig.width=6.6, fig.height=2.5, fig.align='center', set.cap.width=T, num.cols.cap=2, fig.cap = "Human endorsement of comparison class paraphrases (left) and adjective sentences (right) as a function of listener model $L_{1}$ and speaker model $S_{2}$ predictions, respectively. Errorbars correspond to 95\\% bootstrapped confidence intervals for the participant data and 95\\% highest probability density intervals for the model predictions."}
...
fill.colors <- RColorBrewer::brewer.pal(5, "Set2")

...
If you've traveled to San Francisco, you know a cup of coffee can be quite expensive.
...
```{r modelSchematics, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=2, fig.height=2, fig.cap = "Model precictions"}

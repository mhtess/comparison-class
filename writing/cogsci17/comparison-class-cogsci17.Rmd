...
>>>>>>> fbdfbd0ce8eebe13b8231a92fb878bca162b99b1
...
\ndg{probably the Barner pimwit paper is a better cite}
...
<<<<<<< HEAD
\ndg{cite schmidt etal. ask some linguist what the right cites are for comparison classes...}
=======
...
-->
```{r posteriorPredictive_scatters, fig.env = "figure*", fig.pos = "htb", fig.width=6.6, fig.height=2, fig.align='center', set.cap.width=T, num.cols.cap=2, fig.cap = "caption"}

...
A day in January is also a day of the year; if it's warm, it could be *warm for Winter* or *warm relative to a day of the year*. 
...
In Winter, the positive-form adjective phrase "it's warm" should signal a specific class (i.e., "it's warm relative to days in Winter") more so than the negative-form phrase "it's cold," which could signal a specific or general class (e.g., "it's warm relative to days of the year). 

...
Comparison classes are necessary for understanding adjectives and, in fact, any use of language in which pragmatic reconstruction from context is critical, including vague quantifiers [e.g., "He ate a lot of burgers [*for an American / vegetarian*]."; @SchollerFranke2015] and generic language [e.g., "Dogs are friendly [*in comparison to other pets / animals that hunt*]"; @Tessler2016].

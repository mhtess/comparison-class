...
abstract:
    "Speakers often only implicitly refer to a context when using vague language.
...
In Expt. 2 we collect judgements about sentences like "It is warm for a winter day," in which domain knowledge is needed but the comparison class is explicit.

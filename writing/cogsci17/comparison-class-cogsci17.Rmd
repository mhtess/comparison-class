...
The two novel predictions of our language understanding model were borne out in Expt. 1.
...
Rather than measuring these distributions, we make a few assumptions about their functional forms and infer their parameters using Bayesian data analysis.
This by itself will not be sufficient to fill in the probabilistic knowledge that our RSA model relies upon; the model as such will be overparameterized.
We need not worry though; the RSA model is a productive language model, and so we can ask it other questions to gain more traction on the latent world knowledge.

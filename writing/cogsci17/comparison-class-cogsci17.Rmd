...
(2) When the object of discourse (e.g., the day's temperature) is a member of a specific (or, subordinate) class that is expected to fall relatively high on the degree scale (e.g., temperature of a Summer day), positive form adjectives (e.g., *warm*) should lead listeners to prefer the more general (or, superordinate) class than the negative form adjective (e.g., *cold*).

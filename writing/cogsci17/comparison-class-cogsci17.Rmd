...
For each event, participants were given a context sentence to introduce the item, followed by a target sentence, which predicated a positive- or negative-form gradable adjective over the item.
Participants would then be asked if they thought that the The experiment can be viewed in full at LINK.

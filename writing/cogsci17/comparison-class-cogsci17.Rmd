...
The existence of reference classes for understanding vague language is uncontroversial. 
...
Theoretical work in semantics has focused on how information from a comparison class is used and what representations might be preferred [@Solt2009; @Bale2011].
...
We propose that listeners actively combine category knowledge with knowledge about what classes are likely to be talked about to infer the implicit reference class used by the speaker.

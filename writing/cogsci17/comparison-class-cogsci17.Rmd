...
Comparison classes are necessary for understanding adjectives and, in fact, any use of language in which pragmatic reconstruction of context is critical, including vague quantifiers [e.g., "He ate a lot of burgers."; @SchollerFranke2015] and generic language [e.g., "Dogs are friendly"; @Tessler2016].
...
The RSA model makes quantitativs predictions contingent upon the fine-grained details of the relevant prior knowledge.
...
We explicitly put uncertainty over the parameters of the background knowledge being used in our task.

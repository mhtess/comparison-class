...
We find that human listeners infer the most likely comparison class given what their knowledge of the world tells them about the observations that would be remarkable enough for a speaker to mention.
...
The {reference class problem} was originally articulated in the philosophy of mathematics, when one wants to calculate a probability for a singular future event \cite<e.g., the probability that Joe Biden will be re-elected president in 2024>{Reichenbach1949, hajek2007reference}: What is the set of relevant information that should inform such a prediction?
...
Even in ordinary language, the reference problem is present (e.g., what do you mean by \emph{warm}?), and yet human speakers and listeners seem to hardly notice when they fill in this critical aspect of context. % this problem effortlessly. 

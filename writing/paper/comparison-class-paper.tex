...
Each of the 90 item sets contains 3 specific categories, which vary in their general expectations (low, medium, high), within the same general category (e.g., basketball player [high], soccer player [medium], jockey [low]; general category: people). 
The categories within each item set are paired with either a positive-form or negative-form adjective (e.g., tall or short). 
Thus, this experiment had 540 unique items (90 sets $\times$ 3 levels of general expectations (specific categories) $\times$ 2 adjectives).
...
Speaker and listener names were randomized and could not be read off the source .html file.

...
\ndg{i think a little bit. maybe add something like: "Because the adjective endorsement task provides an explicit comparison task, accommodating this data allows us to calibrate the world-knowledge without the effect of comparison class inference."}

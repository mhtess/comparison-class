...
The patterns of inference we observe are consistent with a model of Bayesian reasoning about the likely comparison class, which we into a probabilistic model of adjective interpretation, thus furthering the reach of computational models of language understanding. 

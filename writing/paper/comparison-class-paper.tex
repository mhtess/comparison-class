...
Here, however, we go beyond merely accommodating the item-level variation in the data and attempt to predict the variability in the data using independent measurements of participants'  knowledge of categories and properties.

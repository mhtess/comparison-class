...
This alternative literal listener model also predicts an interaction between general expectations and the adjective polarity, but the directionality of these effects is exactly the opposite from the predictions of the pragmatic model (Figure \ref{fig:altModels}).

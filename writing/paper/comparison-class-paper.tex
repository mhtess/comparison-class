...
In addition to making qualitative predictions about the level-of-abstraction of the inferred comparison class, our model makes quantitative predictions concerning the strength of comparison class inference.
The model's quantitative predictions depend upon model parameters that describe world knowledge $P(x)$ and prior expectations about the comparison class $P(c)$.

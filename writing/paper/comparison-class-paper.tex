...
We automatically categorize responses as either subordinate or superordinate by checking whether the preprocessed response contains the subordinate-NP or superordinate-NP\footnote{Out of our 90 pre-designated superordinate-NPs, one (``deserts'') turned out to be an incorrect guess as to what would be the most salient superordinate category for the subordinate categories (``smoothies'', ``muffins'', ``chocolate fondue'') in the context. We replaced this pre-designated superordinate-NP with the empirically most popular superordinate-NP (``foods'') for purposes of analysis.} as a substring, respectively.\footnote{This analysis assumes that in order to convey a category at least as specific as the subordinate-NP, one must include the subordinate-NP in the response.

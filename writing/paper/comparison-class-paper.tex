...
%We observe an overall preference for subordinate comparison classes for the control (middle-of-the-scale) subordinate categories (e.g., \emph{soccer players}; \brmresults{expt_brm_contrasts_10k.csv}{intercept}) and no  
...
The inferences that result from adjectives that are in conflict with a listener's general expectations of the categories (e.g., tall gymnasts~vs.~short basketball players) were not different between the low-end and high-end items (\brmresults{expt_brm_contrasts_10k.csv}{lowpos_highneg}), nor were the inferences about categories from adjectives that were consistent with general expectations (e.g., short gymnasts~vs.~tall basketball players; \brmresults{expt_brm_contrasts_10k.csv}{lowneg_highpos}).
Thus, general, world-knowledge expectations about the category interface with the adjective used to guide comparison class inferences, as predicted by the model.
...
The overall preference for a subordinate level comparison class and the magnitude of the effect of the adjective varies considerably by item (Figure \ref{fig:ccInferenceItems}).

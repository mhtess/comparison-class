...
After the main comparison class inference trials, participants completed a memory check trial where they had to select (from a checklist of 10 options) all of the adjective--noun phrase pairs (``tall -- basketball player'') that they had seen on the main trials (see SI for full details). 
...
The qualitative results do not change, however, when we exclude these ``other'' responses altogether (see SI for a parallel set of regression results excluding the ``other'' responses). 

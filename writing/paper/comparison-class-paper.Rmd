...
rs.marginal %>%
  ...
  mutate(c = factor(c, levels = c("sub", "super"),
         ...
         utterance = factor(utt, levels = c("ambiguous", "subUtt", "superUtt"),
                      labels = c('"warm"', '"warm for winter"', '"warm for the year"'))) %>%
ggplot(., aes( x = s, y = marginalProb, color = utterance, lty = utterance))+

...
How should a listener decide what comparison class a speaker is considering, when the comparison class goes unsaid? 
...
We propose that listeners actively combine category knowledge with pragmatic considerations to infer the comparison class implicitly used by the speaker.
